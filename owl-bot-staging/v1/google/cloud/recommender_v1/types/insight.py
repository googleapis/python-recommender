...
class Insight(proto.Message):
    ...
    content = proto.Field(proto.MESSAGE, number=3,
    ...
    observation_period = proto.Field(proto.MESSAGE, number=5,
        message=duration.Duration,
    )

    state_info = proto.Field(proto.MESSAGE, number=6,
        message='InsightStateInfo',
    )

    category = proto.Field(proto.ENUM, number=7,
        enum=Category,
    )

    etag = proto.Field(proto.STRING, number=11)

    associated_recommendations = proto.RepeatedField(proto.MESSAGE, number=8,
